...
namespace Timeline47.Api.Migrations
{
    ...
    [Migration("20241124155521_AddJobRecord")]
    partial class AddJobRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SubjectTimelineEvent", b =>
                {
                    ...
                    b.HasKey("EventsId", "SubjectsId");

                    b.HasIndex("SubjectsId");

                    b.ToTable("SubjectTimelineEvent");
                });
            ...
            modelBuilder.Entity("Timeline47.Api.Models.JobRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Timeline47.Api.Models.TimelineEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SubjectTimelineEvent", b =>
                {
                    b.HasOne("Timeline47.Api.Models.TimelineEvent", null)
                        .WithMany()
